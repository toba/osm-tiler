...
import { Options, MemFeature, MemLine, MemPolygon, MemGeometry } from './types'
...
function convertFeature(
   ...
   if (options.promoteID !== undefined) {
   ...
   switch (type) {
      ...
      case Type.MultiPoint: {
         ...
         forEach(points.coordinates, p => convertPoint(p, geometry as MemLine))
         break
      }
      case Type.Line: {
      ...
      case Type.MultiLine: {
         ...
         if (options.lineMetrics) {
            ...
            forEach(lines.coordinates, line => {
               geometry = [] as MemLine
      ...
      case Type.Polygon: {
         ...
         convertLines(poly.coordinates, geometry as MemPolygon, tolerance, true)
         break
      }
